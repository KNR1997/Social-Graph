...
const actionRoutes: Record<string, string> = {
  // 'view' and 'billing' pointed at the Clerk-backed workspaces and billing
  // pages, removed along with Clerk. They fall back to the dashboard rather
  // than routing to a 404.
