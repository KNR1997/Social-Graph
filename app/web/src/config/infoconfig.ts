  ...
  sections: [
    {
      title: 'Overview',
      description:
        'The Products page allows you to manage your product catalog. You can view all products in a table with sorting, filtering, pagination, and search, all driven through the URL. Use the "Add New" button to create new products.',
      links: [
        {
